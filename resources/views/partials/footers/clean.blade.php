    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div class="flex flex-col items-center text-center space-y-8">
            ...
            <flux:subheading class="max-w-md text-base leading-relaxed text-balance">
                {{ __('Construido con tecnología de vanguardia para sitios web excepcionales y de máxima velocidad.', 'sage') }}
            </flux:subheading>
            ...
            <div class="flex flex-wrap justify-center items-center gap-2 sm:gap-4">
                <flux:button variant="ghost" size="sm" href="#" wire:navigate class="!text-zinc-500 hover:!text-accent-600 dark:hover:!text-accent-400">{{ __('Privacidad', 'sage') }}</flux:button>
                <flux:button variant="ghost" size="sm" href="#" wire:navigate class="!text-zinc-500 hover:!text-accent-600 dark:hover:!text-accent-400">{{ __('Términos', 'sage') }}</flux:button>
                <flux:button variant="ghost" size="sm" href="#" wire:navigate class="!text-zinc-500 hover:!text-accent-600 dark:hover:!text-accent-400">{{ __('Contacto', 'sage') }}</flux:button>
            ...
            <flux:text class="text-zinc-400 dark:text-zinc-600 mt-8">
                &copy; {{ $currentYear }} {!! $siteName !!}. {{ __('Todos los derechos reservados.', 'sage') }}
            </flux:text>
        </div>
    </div>
</footer>
