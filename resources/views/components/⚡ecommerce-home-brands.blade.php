                ...
                >
                    @foreach($this->brands as $brand)
                        ...
                        <a
                            ...
                            wire:navigate
                            data-brand-item
                            class="group relative block shrink-0 min-w-[180px] sm:min-w-[205px] lg:min-w-[225px] aspect-[1.45/1] overflow-hidden rounded-3xl border border-zinc-200/70 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-900 snap-start shadow-sm hover:shadow-lg transition-shadow"
                        >
                            @if($brandImage !== '')
