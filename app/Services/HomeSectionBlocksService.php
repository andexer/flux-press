...
class HomeSectionBlocksService
{
    ...
    public function getDefaultSectionData(string $type, array $override = []): array
    {
        $defaults = [
            'hero' => [
                'title' => __('Your Amazing Title', 'sage'),
                'subtitle' => __('Describe your value proposition here', 'sage'),
                'badge' => '',
                'badge_color' => 'sky',
                'image' => '',
                'primary_label' => __('Get Started', 'sage'),
                'primary_url' => '#',
            ],
            'features' => [
                'title' => __('Why Choose Us', 'sage'),
                'items' => [
                    ['icon' => 'shield-check', 'title' => __('Feature 1', 'sage'), 'text' => __('Description of feature 1', 'sage')],
                    ['icon' => 'bolt', 'title' => __('Feature 2', 'sage'), 'text' => __('Description of feature 2', 'sage')],
                    ['icon' => 'chart-bar', 'title' => __('Feature 3', 'sage'), 'text' => __('Description of feature 3', 'sage')],
                ],
            ],
            'stats' => [
                'title' => '',
                'items' => [
                    ['value' => '100+', 'label' => __('Clients', 'sage')],
                    ['value' => '99%', 'label' => __('Uptime', 'sage')],
                    ['value' => '24/7', 'label' => __('Support', 'sage')],
                    ['value' => '5★', 'label' => __('Rating', 'sage')],
                ],
            ],
            'cta' => [
                'title' => __('Ready to Get Started?', 'sage'),
                'description' => __('Join thousands of satisfied customers today.', 'sage'),
                'button_text' => __('Contact Us', 'sage'),
                'button_url' => '#',
                'bg_color' => 'bg-slate-900',
            ],
            'testimonials' => [
                'title' => __('What Our Clients Say', 'sage'),
                'items' => [
                    ['quote' => __('Great service!', 'sage'), 'author' => __('John Doe', 'sage'), 'role' => 'CEO'],
                    ['quote' => __('Highly recommended!', 'sage'), 'author' => __('Jane Smith', 'sage'), 'role' => 'CTO'],
                ],
            ],
            'team' => [
                'title' => __('Meet Our Team', 'sage'),
                'items' => [
                    ['name' => __('Team Member 1', 'sage'), 'role' => __('Position', 'sage'), 'image' => ''],
                    ['name' => __('Team Member 2', 'sage'), 'role' => __('Position', 'sage'), 'image' => ''],
                ],
            ],
            'pricing' => [
                'title' => __('Our Pricing', 'sage'),
                'items' => [
                    ['name' => __('Basic', 'sage'), 'price' => '$9', 'features' => [__('Feature 1', 'sage'), __('Feature 2', 'sage')]],
                    ['name' => __('Pro', 'sage'), 'price' => '$29', 'features' => [__('Feature 1', 'sage'), __('Feature 2', 'sage'), __('Feature 3', 'sage')]],
                ],
            ],
            'faq' => [
                'title' => __('Frequently Asked Questions', 'sage'),
                'items' => [
                    ['question' => __('Question 1?', 'sage'), 'answer' => __('Answer 1', 'sage')],
                    ['question' => __('Question 2?', 'sage'), 'answer' => __('Answer 2', 'sage')],
                ],
            ],
            'blog' => [
                'title' => __('Latest from Blog', 'sage'),
                'limit' => 3,
            ],
            'contact' => [
                'title' => __('Get in Touch', 'sage'),
