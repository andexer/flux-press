...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Registro de layouts disponibles para el tema. Cada layout define una
    | estructura visual distinta. Se pueden seleccionar por página o globalmente
    | desde el WordPress Customizer.
    |
    */

    'layouts' => [
        'default'    => 'layouts.app',
        'corporate'  => 'layouts.corporate',
        'saas'       => 'layouts.saas',
        'minimal'    => 'layouts.minimal',
        'ecommerce'  => 'layouts.ecommerce',
    ],
