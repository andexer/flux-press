    ...
    */
    ...
    'home' => [
        ...
        'layouts' => [
            ...
            'saas' => 'SaaS — Hero + Features + Stats + Testimonials',
            'startup' => 'Startup — Hero + Features + Pricing + CTA',
            'portfolio' => 'Portfolio — Hero + Projects + About + Contact',
            'restaurant' => 'Restaurant — Hero + Menu + Reviews + Reserve',
            'medical' => 'Medical — Hero + Services + Team + Contact',
            'education' => 'Education — Hero + Courses + Testimonials + CTA',
        ...
        'sections' => [
            ...
            'show_widgets' => true,
            'posts_limit' => 6,
            'order' => 'hero,features,stats,posts,cta,widgets',
        ],
        'content' => [
            'hero' => [
                'title' => '',
